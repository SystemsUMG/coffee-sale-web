    ...
    <script>
        ...
        function payBank() {
            ...
            if (formCard) {
                ...
                cvv = formCard.querySelector('#cvv').value
            }
            ...
            axios.post('https://app-ryypjkir5a-uc.a.run.app/payments/create', {
                headers: {
                    'Content-Type': 'application/json'
                },
                "businessID": "HKHNk6TAzV9HG2RV4uZa",
                ...
                .catch(function (error) {
                    let message = error.response.status === 400 ? error.response.data.error : 'El banco no pudo realizar la transacción.'
                    showToast('Error', message, 'danger', 'bi bi-x-circle-fill text-danger fs-3 me-2');
                    loaderElement.classList.add("d-none");
                })
        }

        function generateSale(response) {
